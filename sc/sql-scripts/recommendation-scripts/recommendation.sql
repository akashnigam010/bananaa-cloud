...
CREATE TABLE `bna`.`DISH_SUGGESTION_MAPPING` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `DISH_ID` INT NOT NULL,
  `SUGGESTION_ID` INT NOT NULL,
	PRIMARY KEY (`ID`),
	CONSTRAINT `DSM_DISH_FK`
	FOREIGN KEY (`DISH_ID`)
	REFERENCES `bna`.`DISH` (`ID`),
	CONSTRAINT `DSM_SUGGESTION_FK`
...
CREATE TABLE `bna`.`DISH_CUISINE_MAPPING` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `DISH_ID` INT NOT NULL,
  `CUISINE_ID` INT NOT NULL,
	PRIMARY KEY (`ID`),
	CONSTRAINT `DCM_DISH_FK`
	FOREIGN KEY (`DISH_ID`)
	REFERENCES `bna`.`DISH` (`ID`),
	CONSTRAINT `DCM_CUISINE_FK`
