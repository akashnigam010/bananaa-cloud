...
FOR EACH ROW 
BEGIN  
	INSERT INTO Socyal.USER_AUDIT(`ID`, `FIRST_NAME`, `IMAGE_URL`, `EMAIL`, `LAST_NAME`, `GENDER`, `FACEBOOK_ID`, `FACEBOOK_LINK`, `FACEBOOK_TOKEN`, `CREATED_DATETIME`, `UPDATED_DATETIME`)
    SELECT `ID`, `FIRST_NAME`, `IMAGE_URL`, `EMAIL`, `LAST_NAME`, `GENDER`, `FACEBOOK_ID`, `FACEBOOK_LINK`, `FACEBOOK_TOKEN`, `CREATED_DATETIME`, `UPDATED_DATETIME`
