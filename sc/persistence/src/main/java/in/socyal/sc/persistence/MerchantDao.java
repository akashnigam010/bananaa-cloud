...
public class MerchantDao {
	...
	/**
	 * This method is used to fetch merchant list using criteria sorting logic
	 * is happening on PROMOTION value
	 * 
	 * @param request
	 * @return
	 */
	...
	/**
	 * This method is used to fetch merchant list using native sql query sorting
	 * logic is happening based on distance
	 * 
	 * @param request
	 * @return
	 */
	...
	private String sortMerchantsByDistanceQuery() {
		...
		query.append(
				"ORDER BY Socyal.DISTANCE_BETWEEN_COORDINATES(:latitude, :longitude, a.LATITUDE, a.LONGITUDE) ASC");
