...
public class FeedbackDelegateImpl implements FeedbackDelegate {
	...
	public BusinessCheckinDetailsResponse businessAskFeedback(FeedbackRequest request) {
		BusinessCheckinDetailsResponse response = businessAskFeedbackResponse();
		return response;
	}
	
	@Override
	@Transactional(propagation = Propagation.REQUIRES_NEW)
	public BusinessCheckinDetailsResponse businessCancelFeedback(FeedbackRequest request)
			throws BusinessException {
		BusinessCheckinDetailsResponse response = businessCancelFeedbackResponse();
		return response;
	}
	
	//FIXME : dummy response, replace with actual logic
	private BusinessCheckinDetailsResponse businessAskFeedbackResponse() {
	...
	//FIXME : dummy response, replace with actual logic
		private BusinessCheckinDetailsResponse businessCancelFeedbackResponse() {
			BusinessCheckinDetailsResponse response = new BusinessCheckinDetailsResponse();
			UserDetailsResponse userDetails = new UserDetailsResponse();
			userDetails.setId(41);
			userDetails.setImageUrl("https://scontent.xx.fbcdn.net/v/t1.0-1/c1.0.160.160/p160x160/15578891_1180564885332226_632797692936181444_n.jpg?oh=7834859a26b7b40c9801ad1e563e9015&oe=58FF1D94");
